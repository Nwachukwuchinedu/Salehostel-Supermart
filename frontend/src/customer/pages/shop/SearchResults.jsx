        ...
        <div className="flex-1">
          {viewMode === 'grid' ? (
            ...
            <div className="space-y-6">
              {searchResults.map((product) => (
                <div key={product._id} className="customer-glass-card rounded-2xl p-6 flex">
                  ...
                  <div className="ml-6 flex-1">
                    ...
                    <div className="mt-2 flex items-center">
                      <span className="text-xl font-bold text-customer-gray-900">
          ...
          <div className="flex items-center justify-between mt-12">
            <p className="text-customer-gray-600">Showing {searchResults.length} of {totalResults} products</p>
            <div className="flex gap-2">
              ...
              <button className="customer-btn-primary">{pagination.page}</button>
              <button 
                className="customer-btn-secondary"
