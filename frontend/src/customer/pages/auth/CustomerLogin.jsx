    ...
    <div className="min-h-screen bg-gradient-to-br from-customer-primary/10 to-customer-secondary/10 flex items-center justify-center p-4">
      <div className="customer-glass-card w-full max-w-md p-8 rounded-2xl">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-customer-primary mb-2">Welcome Back</h1>
          <p className="text-customer-gray-600">Sign in to your account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              />
              <label htmlFor="remember-me" className="ml-2 block text-sm text-customer-gray-700">
                Remember me
              </label>
            </div>
            <Link to="/forgot-password" className="text-sm text-customer-primary hover:text-customer-secondary">
              Forgot password?
            </Link>
          </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-customer-gray-600">
            ...
            <Link to="/register" className="text-customer-primary font-medium hover:text-customer-secondary">
              Sign up
            </Link>
          </p>
        </div>
        
        <div className="mt-8 pt-6 border-t border-customer-gray-200">
          <div className="flex items-center">
            <div className="flex-grow border-t border-customer-gray-300"></div>
            <span className="flex-shrink mx-4 text-customer-gray-500 text-sm">Or continue with</span>
            <div className="flex-grow border-t border-customer-gray-300"></div>
          </div>
          <div className="mt-6 grid grid-cols-2 gap-3">
            <button className="customer-btn-secondary flex items-center justify-center">
